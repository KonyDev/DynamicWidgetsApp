...
function hBoxForHeader() {
    ...
    if (kony.os.deviceInfo().name == "android" || kony.os.deviceInfo().name == "thinclient" || kony.os.deviceInfo().name == "blackberry" || kony.os.deviceInfo().name == "WindowsPhone") headerHbox.add(lblForHeader(), btnAdd("Add"));
...
function hBoxForHeader2() {
    ...
    var headerHbox = new kony.ui.Box(hboxbasic1, hboxlayout1, {});
    if (kony.os.deviceInfo().name == "android" || kony.os.deviceInfo().name == "thinclient" || kony.os.deviceInfo().name == "blackberry" || kony.os.deviceInfo().name == "WindowsPhone") headerHbox.add(lblForHeader2());
    else headerHbox.add(backBtnForHeader(), lblForHeader2());
    return headerHbox;
}
...
function lblForHeader() {
    var lblBasicConf1 = {
        ...
        text: "Locally Packaged",
        isVisible: true,
        skin: "lblNormal"
    };
    var lbllayoutConf1;
    if (kony.os.deviceInfo().name == "android" || kony.os.deviceInfo().name == "thinclient" || kony.os.deviceInfo().name == "blackberry") lbllayoutConf1 = {
        containerWeight: 80,
        hExpand: true,
        margin: [0, 0, 0, 0],
    ...
    else if (kony.os.deviceInfo().name == "WindowsPhone") lbllayoutConf1 = {
        containerWeight: 80,
        hExpand: true,
        margin: [6, 0, 0, 0],
        widgetAlignment: constants.WIDGET_ALIGN_CENTER,
...
function btnAdd(text) {
    ...
    else if (kony.os.deviceInfo().name == "android" || kony.os.deviceInfo().name == "blackberry" || kony.os.deviceInfo().name == "thinclient" || kony.os.deviceInfo().name == "WindowsPhone") btnLayout = {
        widgetAlignment: constants.WIDGET_ALIGN_CENTER,
        vExpand: false,
        hExpand: true,
        margin: [0, 0, 0, 0],
...
function btnForPlaceAnOrder(text) {
    ...
    var btnLayout;
    if (kony.os.deviceInfo().name == "WindowsPhone") btnLayout = {
        widgetAlignment: constants.WIDGET_ALIGN_CENTER,
        vExpand: false,
        hExpand: true,
        margin: [30, 30, 30, 30],
