...
function listBoxForCountry() {
    ...
    try {
        ...
        if (kony.os.deviceInfo().name == "android") var listLayoutConf1 = {
            containerWeight: 60,
            hExpand: true,
            widgetAlignment: constants.WIDGET_ALIGN_MIDDLE_LEFT,
            margin: [0, 1, 2, 0],
...
function textBoxForName() {
    ...
    if (kony.os.deviceInfo().name == "android") return new kony.ui.TextBox2(txtBoxBasic1, {
        containerWeight: 60,
        hExpand: true,
        margin: [0, 1, 2, 0],
        padding: [0, 2, 0, 2],
    ...
    else return new kony.ui.TextBox2(txtBoxBasic1, {
        containerWeight: 60,
        hExpand: true,
        margin: [0, 1, 2, 0],
        padding: [0, 1, 0, 1],
...
function createDynamicForm() {
    try {
        ...
        var frmLogBasiConf = {
            ...
            addWidgets: addWidgetsToDynamicForm,
            skin: "frmSampleSkin",
...
function callbackfunction(status, result) {
    if (status == 400) {
        ...
        if (result["opstatus"] == 0) { //eval(javaString["evalstring"]);
